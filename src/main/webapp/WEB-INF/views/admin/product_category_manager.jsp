					...
					<div class="row">
						<div class="col-md-12">
							<div class="card card-topline-aqua">
								<div class="card-head">
									<header>Bảng dữ liệu loại sản phẩm</header>
									<div class="tools">
								...
								<div class="card-body ">
									<div class="table-scrollable">
										<table id="example1" class="display" style="width: 100%;">
											...
											<c:forEach var="productCategorys" items="${productCategory}">
												<tr>
													<td><input type="checkbox" id="checkbox_${productCategorys.id}"
																value="${productCategorys.id}" /></td>
													<td>${productCategorys.code}</td>
													<td>${productCategorys.name}</td>
													<td>${productCategorys.createBy}</td>
													<td>${productCategorys.modifyBy}</td>
