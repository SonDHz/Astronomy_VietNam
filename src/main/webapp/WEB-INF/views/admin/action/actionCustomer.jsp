												...
												<div class="col-md-4">
													<div class="input-icon right">
														<i class="fa"></i> <form:input path="createBy" type="text" class="form-control"
															name="createBy" id="createBy" value="${model.createdBy}"/>
													</div>
												</div>
											</div>
											<div class="form-group row">
												...
												<div class="col-md-4">
													<div class="input-icon right">
														<i class="fa"></i> <form:input path="modifyBy" type="text" class="form-control"
															name="modifyBy" id="modifyBy" value="${model.modifiedBy}" />
													</div>
												</div>
											</div> --%>
										</div>
										<form:hidden path="id" id="idCustomer"/>
										<div class="form-group">
											<div class="offset-md-3 col-md-9">
											<c:if test="${not empty model.id}">
												<button type="button" class="btn btn-info" id="btnAddOrUpdate">Cập nhật khách hàng</button>
											</c:if>
											<c:if test="${empty model.id}">
												<button type="button" class="btn btn-info" id="btnAddOrUpdate">Thêm khách hàng</button>
											</c:if>
											</div>
										</div>
									</form:form> 
		...
		function add(data){
			$.ajax({
				...
				success: function(result){
					 window.location.href = "${customerURL}?id="+result.id+"&message=insert_success";   
				},
