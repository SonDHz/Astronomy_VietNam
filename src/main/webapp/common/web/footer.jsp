		...
		<div class="container box_1170">
			<div class="row">
				<div class="col-lg-3 col-md-6 col-sm-6">
					<div class="single-footer-widget">
						<h6 class="footer_title">Về Thiên Văn Việt</h6>
						<p>Chúng tôi yêu cầu tất cả các độc giả nếu copy và tái sửa dụng bất cứ bài viết nào tại website này ở
						các tài liệu, website, forum, hoặc mạng xã hội khác cần ghi rõ nguồn lấy bài và kèm tên tác giả.</p>
					</div>
				</div>
				<div class="col-lg-3 col-md-6 col-sm-6">
					<div class="single-footer-widget">
						<h6 class="footer_title">Email</h6>
						<p>Nếu có thắc mắc hoặc muốn liên lạc xin vui lòng gửi email vào bên dưới.</p>
				...
				<div class="col-lg-4 col-md-6 col-sm-6">
					<div class="single-footer-widget instafeed">
						...
						<ul class="list instafeed d-flex flex-wrap">
							...
							<li><img src="<c:url value ='/template/web/img/i4.jpg'/>" alt=""></li>
							<li><img src="<c:url value ='/template/web/img/i5.jpg'/>" alt=""></li>
				...
				<div class="col-lg-2 col-md-6 col-sm-6">
					<div class="single-footer-widget f_social_wd">
						<h6 class="footer_title">Theo dõi Thiên Văn Việt</h6>
						<p>Các nền tảng mạng xã hội</p>
						<div class="f_social">
			...
			<div
				...
				<p class="col-lg-12 footer-text text-center">
					...
					Dự án tốt nghiệp "Thiên Văn Việt" - Astronomy
					<script>
						document.write(new Date().getFullYear());
					</script>
					 | Thực hiện bởi Nhóm 4 - FPT Polytechnic
